...
const Experiences = () => {
	...
	// 'https://images.unsplash.com/photo-1627272973275-019927dd1394?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80'
	...
	return (
		<SideBar setIsOpenCurtain={setIsOpenCurtain}>
			...
			<section className='exp-main-container'>
				...
				{work_as_an_employee.length !== 0 && (
					<Working work_as_an_employee={business} ref={workContainerWrapper} />
				)}
				<ScrollToDiscover />
			</section>
		</SideBar>
