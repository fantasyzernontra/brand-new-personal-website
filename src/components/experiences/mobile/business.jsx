				...
				<div className='business-mobile-container' key={index}>
					...
					<section id='content-mobile'>
						<div className='business-content-mobile-container'>
							<span className='business-content-label-mobile'>
								business name
							</span>
							<h2 className='business-title-mobile'>{item.exp_full_name}</h2>
						</div>
						<div className='business-content-mobile-container'>
							<span className='business-content-label-mobile'>
								business description
							</span>
							<h2 className='business-title-mobile'>{item.exp_desc}</h2>
						</div>
						<div className='business-content-mobile-container'>
							<span className='business-content-label-mobile'>
								establishment year
							</span>
							<h2 className='business-title-mobile'>
						...
						<div className='business-content-mobile-container'>
							...
							<h2 className='business-title-mobile duration-500 hover:text-soft_pink text-base'>
